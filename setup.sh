...
echo -e " Auther : ${green}BANGJOE VPN ${NC}"
echo -e " © SURABAYA / BANGKALAN ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Bangjoevpn/BANGJOE/main/"
...
wget -q https://raw.githubusercontent.com/Bangjoevpn/BANGJOE/main/config/limmit && chmod +x limmit && ./limmit
